...
export function EditListing() {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      widthValue: String(productQuery.data.widthValue ?? ""),
      heightValue: String(productQuery.data.heightValue ?? ""),
      sizeUnit: productQuery.data.sizeUnit ?? "CM",
    });
  }, [productQuery.data]);
